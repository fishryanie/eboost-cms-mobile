  ...
  const frontCard = (
    <CardSurface>
      ...
      <ThemedView flexDirection='row' flexWrap='wrap' gap={'two'}>
        ...
        <ThemedView backgroundColor='#FFF5FA' borderColor='#F8CDE1' borderRadius={'small'} borderWidth={1} paddingHorizontal={'two'} paddingVertical={'one'}>
      ...
      <FlipCard.Back>
        <FlipCard.Trigger>
          <ThemedView
            ...
            overflow='hidden'
            width='100%'>
            <ChargingProfileChart compact fallbackEnergyKwh={session?.wattage_consumed} mobileCard transactionId={transactionId} />
          </ThemedView>
        </FlipCard.Trigger>
      </FlipCard.Back>
    </FlipCard>
