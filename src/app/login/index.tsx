...
const formGap = 'four';
const radiusLarge = 'large';
const radiusMedium = 'medium';
const radiusPill = 'pill';
        ...
        <TouchableWithoutFeedback accessible={false} onPress={Keyboard.dismiss}>
          <ScrollView
            ...
            <ThemedView alignItems='center' marginBottom={'six'}>
              <ThemedView backgroundColor='#E8F4EF' borderRadius={radiusPill} marginBottom={'four'} paddingHorizontal={'four'} paddingVertical={7}>
                <ThemedText color={Palette.accent} fontFamily={FontFamily.bold} fontSize={11} letterSpacing={0}>
                  CMS Admin Portal
                </ThemedText>
              </ThemedView>
              <ThemedText color={Palette.textPrimary} fontFamily={FontFamily.bold} fontSize={36} lineHeight={42} marginBottom={'two'} textAlign='center'>
                Welcome back! 👋
              </ThemedText>
            ...
            <ThemedView
              ...
              <ThemedView alignItems='center' flexDirection='row' justifyContent='flex-start' marginBottom={12}>
                ...
                <ThemedView borderLeftColor={Palette.borderSubtle} borderLeftWidth={1} flex={1} gap={'half'} paddingLeft={'two'}>
              ...
              {errorMessage ? (
                <ThemedView backgroundColor={Palette.dangerSurface} borderColor='#FDA29B' borderRadius={radiusMedium} borderWidth={1} padding={'three'}>
              ...
              <ThemedView rowCenter flex={1} gap={'two'}>
                <AppButton
            ...
            <ThemedView alignItems='center' gap={'half'} marginTop={'six'}>
