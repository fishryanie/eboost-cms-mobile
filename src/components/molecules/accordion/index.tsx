...
const Accordion = ({ children, type = 'single', theme = AccordionThemes.light, spacing = 0 }: AccordionProps) => {
...
const AccordionItem = ({ children, value, pop = false, icon = 'chevron', popScale = 1.02, isLast = false }: AccordionItemProps) => {
    ...
    <>
      ...
      <Animated.View style={animatedStyle}>
        <View style={styles.contentWrapper}>
          <Animated.View style={[styles.content, Platform.OS === 'android' && animatedAndroidBlurStylez]}>{children}</Animated.View>
          {Platform.OS === 'ios' && (
            <AnimatedBlurView
              tint={
                theme.backgroundColor === '#18181b' || theme.backgroundColor === '#0c4a6e' || theme.backgroundColor === '#7c2d12'
                  ? 'dark'
