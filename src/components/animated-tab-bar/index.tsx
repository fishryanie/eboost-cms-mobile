...
const AnimatedTabBar: FC<IAnimatedTabBarProps> & FunctionComponent<IAnimatedTabBarProps> = memo<IAnimatedTabBarProps & ComponentProps<typeof AnimatedTabBar>>(
  (props: IAnimatedTabBarProps & ComponentProps<typeof AnimatedTabBar>): (ReactNode & ReactElement & JSX.Element) | null => {
    ...
    return (
      <ThemedView pointerEvents='box-none' style={[StyleSheet.absoluteFill, styles.root]}>
        ...
        <ThemedView pointerEvents='box-none' style={[styles.dock, { paddingBottom: Math.max(insets.bottom, 12) }]}>
...
export type { IAnimatedTabBarProps, IPalette, IPopupRenderContext, TActiveView } from './types';
